...
export default function StockExchangeHistoryPage() {
          ...
          <div className="@container/main flex flex-1 flex-col gap-2">
            <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6 px-4 lg:px-6">
              <StockOperationsHistory
                ...
                description="View all past stock exchange operations"
                backPath={APP_PATHS.STOCK_EXCHANGE}
                newOperationPath={APP_PATHS.STOCK_EXCHANGE}
                icon={RefreshCw}
                searchPlaceholder="Search by order, customer, warehouse, SKU..."
              />
            </div>
          </div>
        </div>
