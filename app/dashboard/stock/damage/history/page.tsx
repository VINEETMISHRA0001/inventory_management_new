...
export default function StockDamageHistoryPage() {
          ...
          <div className="@container/main flex flex-1 flex-col gap-2">
            <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6 px-4 lg:px-6">
              <StockOperationsHistory
                ...
                title="Damage/Breakage History"
                description="View all past damage/breakage operations"
                backPath={APP_PATHS.STOCK_DAMAGE}
                newOperationPath={APP_PATHS.STOCK_DAMAGE}
                icon={AlertTriangle}
                searchPlaceholder="Search by warehouse, SKU, reason..."
              />
            </div>
          </div>
        </div>
