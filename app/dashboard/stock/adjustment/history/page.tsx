          ...
          <div className="@container/main flex flex-1 flex-col gap-2">
            <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6 px-4 lg:px-6">
              <StockOperationsHistory
                ...
                description="View all past stock adjustment operations"
                backPath={APP_PATHS.STOCK_ADJUSTMENT}
                newOperationPath={APP_PATHS.STOCK_ADJUSTMENT}
                icon={Edit}
                searchPlaceholder="Search by warehouse, SKU..."
              />
            </div>
          </div>
        </div>
